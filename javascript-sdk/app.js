...
//Update a record
    ...
    //Insert a ip
    window.app.addAdsinfo = function () {
//        var n = "android";
//        var i = new Date + "";
//        var item = {record: [
//            {type: n, date: i, counts: 100}
//        ]};
//        console.log("createRecords");
//        window.df.apis.db.createRecords({"table_name":"plane", "body":item}, function(response) {
//            console.log("create success");
//        }, function(response) {
//            console.error("create fail",response._body._body);
//        });
        console.log("getTables");
        window.df.apis.db.getTables(function (response) {
            console.log("getTables success",response._body._body);

        }, function(response) {
            console.error("getTables fail",response._body._body);
        });
    };
}, false);
